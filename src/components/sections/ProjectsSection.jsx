...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-bg-light dark:bg-bg-dark relative">
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            <motion.div
              className="bg-bg-light dark:bg-bg-dark border border-neon-purple/30 shadow-[0_0_30px_rgba(192,132,252,0.2)] rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto"
